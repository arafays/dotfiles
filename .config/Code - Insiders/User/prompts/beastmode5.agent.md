...
tools: ['edit', 'search', 'runCommands', 'runTasks', 'chromedevtools/chrome-devtools-mcp/*', 'cognitionai/deepwiki/*', 'memory/*', 'microsoft/playwright-mcp/*', 'sequentialthinking/*', 'upstash/context7/*', 'runSubagent', 'usages', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'todos']
---
