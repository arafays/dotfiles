...
Item {
  ...
  Process {
    id: _probeProcess
    command: ["sh", "-c", "(python3 -c 'import sherpa_onnx, sounddevice, numpy' 2>/dev/null || python3 -c 'import faster_whisper, sounddevice, numpy' 2>/dev/null) && echo system-python-ready"]
