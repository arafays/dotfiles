...
// NOTE: manually ported to the OpenCode 2 terminal plugin API and moved to
// plugins/tui/ (v2 discovers global terminal plugins there). Reinstalling
// herdr's integration restores the OpenCode 1 version, which will not load in v2.
    ...
    const syncSelectedSession = async () => {
      ...
      const session =
        typeof sessionID === "string" && sessionID
          ? ctx.data.session.get(sessionID)
          : undefined;
