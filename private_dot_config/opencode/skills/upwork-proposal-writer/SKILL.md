...
| Xulfi Shah Portfolio | Next.js 15, Payload CMS 3.x (db-postgres), Three.js (@react-three/drei/fiber/postprocessing), GSAP, Leva, Embla Carousel, Tailwind v4, Biome | <https://xulfi-me.vercel.app/> | Designer portfolio with interactive 3D model viewer, custom environment presets (Dawn/City/Forest etc), material controls, carousel showcases |
