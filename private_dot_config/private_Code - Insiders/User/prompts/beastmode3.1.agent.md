...
tools: ['runCommands', 'runTasks', 'chromedevtools/chrome-devtools-mcp/*', 'memory/*', 'microsoft/playwright-mcp/*', 'sequentialthinking/*', 'upstash/context7/*', 'edit', 'search', 'new', 'cognitionai/deepwiki/*', 'extensions', 'todos', 'runSubagent', 'usages', 'vscodeAPI', 'problems', 'changes', 'testFailure', 'openSimpleBrowser', 'fetch', 'githubRepo']
---
